...
public class ViewItemActivity extends Activity 
{
	public void onCreate(Bundle savedInstanceState)
	{
		...
		final TextView categoryText = (TextView) findViewById(R.id.category_text);
		final TextView locationText = (TextView) findViewById(R.id.location_text);
		final TextView rewardText = (TextView) findViewById(R.id.reward_text);
